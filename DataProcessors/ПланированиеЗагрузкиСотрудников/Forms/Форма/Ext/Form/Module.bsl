...
Процедура ЗаполнитьПланировщикНаСервере()
	...
	|		ПРАВОЕ СОЕДИНЕНИЕ Документ.ЗаписьКлиента КАК ЗаписьКлиента
	...
	Пока ВыборкаСотрудники.Следующий() Цикл
		...
		Пока Выборка.Следующий() Цикл
			...
			КонецЕсли;
			Если Выборка.ПризнакОплаты = ПредопределенноеЗначение("Перечисление.ОплатаДокумента.ПолностьюОплачен") Тогда
